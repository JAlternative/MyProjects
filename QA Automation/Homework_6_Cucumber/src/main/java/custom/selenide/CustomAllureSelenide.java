...
/**
 * Собственный класс для функции скриншотов
...
public class CustomAllureSelenide extends AllureSelenide {
    ...
    private LogEvent.EventStatus screenshotEventStatus;
    ...
    public CustomAllureSelenide screenshots(boolean saveScreenshots) {
        this.saveScreenshots = saveScreenshots;
        return this;
    }

    public CustomAllureSelenide savePageSource(boolean savePageHtml) {
        this.savePageHtml = savePageHtml;
        return this;
    }

    public CustomAllureSelenide includeSelenideSteps(boolean includeSelenideSteps) {
        this.includeSelenideLocatorsSteps = includeSelenideSteps;
        return this;
    }

    public CustomAllureSelenide enableLogs(LogType logType, Level logLevel) {
        this.logTypesToSave.put(logType, logLevel);
        return this;
    }

    public CustomAllureSelenide disableLogs(LogType logType) {
        this.logTypesToSave.remove(logType);
        return this;
    }

    public CustomAllureSelenide screenOfEventStatus(LogEvent.EventStatus eventStatus) {
        this.screenshotEventStatus = eventStatus;
        return this;
    }
    ...
    public void afterEvent(LogEvent event) {
        if (event.getStatus().equals(screenshotEventStatus)) {
